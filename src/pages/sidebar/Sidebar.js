...
const Sidebar = () => {
  ...
  return (
    <aside class="w-64 h-full min-h-screen" aria-label="Sidebar">
      <div class="py-4 px-3 rounded-r-xl bg-red-500 h-full min-h-screen">
        <div className="flex px-3 py-3 mb-5 text-white">
